...
const SignupPage = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast({ title: "Account created!", description: "Welcome to CreatorHub (demo mode)." });
      navigate("/dashboard");
    }, 500);
  };
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              <div>
                ...
                <div className="relative mt-1.5">
                  ...
                  <Input id="username" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="yourname" className="pl-10" required />
                </div>
              </div>
              <div>
